...
RENTER_COLUMNS_MAPPING = { 						# RenterType による契約者マッピング条件の辞書
	"個人": {
		"契約者":[
			...
			("CompanyAddress__c__PostalCode__s","applicant_workplace_address","zip_code"),
			("CompanyAddress__c__State__s","applicant_workplace_address","state"),
			("CompanyAddress__c__City__s","applicant_workplace_address","city"),
			("CompanyAddress__c__Street__s","applicant_workplace_address","street"),
